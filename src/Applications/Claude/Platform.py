...
LEVELS = [
    ...
    {
        "name": "Icy Steps",
        "bg_color": (150, 210, 240),
        "tiles": (
            [('G', c, 13) for c in range(0, 8)]
            + [('G', c, 14) for c in range(0, 8)]
            + [('P', c, 11) for c in range(8, 12)]
            + [('P', c, 9) for c in range(12, 16)]
            + [('P', c, 7) for c in range(16, 20)]
            + [('P', c, 10) for c in range(21, 25)]
            + [('P', c, 8) for c in range(26, 30)]
            + [('G', c, 13) for c in range(31, 38)]
            + [('G', c, 14) for c in range(31, 38)]
        ),
        "coins": [
            (3, 12), (5, 12),
            (9, 10), (10, 10),
    ...
    # ── Level 5: Glacier Gaps ────────────────────────────────────────────────
    {
        "name": "Glacier Gaps",
        "bg_color": (120, 190, 235),
        "tiles": (
            [('G', c, 13) for c in range(0, 6)]
            + [('G', c, 14) for c in range(0, 6)]
            + [('G', c, 13) for c in range(8, 13)]
            + [('G', c, 14) for c in range(8, 13)]
            + [('G', c, 13) for c in range(16, 21)]
            + [('G', c, 14) for c in range(16, 21)]
            + [('G', c, 13) for c in range(24, 30)]
            + [('G', c, 14) for c in range(24, 30)]
            + [('G', c, 13) for c in range(33, 40)]
            + [('G', c, 14) for c in range(33, 40)]
            + [('P', c, 10) for c in range(4, 8)]
            + [('P', c, 8) for c in range(12, 16)]
            + [('P', c, 10) for c in range(20, 24)]
            + [('P', c, 7) for c in range(27, 32)]
        ),
        "coins": [
            (2, 12), (5, 9),
            (9, 12), (13, 7), (14, 7),
    ...
    # ── Level 6: Crate Cliffs ────────────────────────────────────────────────
    {
        "name": "Crate Cliffs",
        "bg_color": (175, 205, 225),
        "tiles": (
            [('G', c, 13) for c in range(0, 36)]
            + [('G', c, 14) for c in range(0, 36)]
            + [('P', c, 11) for c in range(4, 7)]
            + [('P', c, 9) for c in range(9, 12)]
            + [('P', c, 6) for c in range(13, 17)]
            + [('P', c, 9) for c in range(18, 21)]
            + [('P', c, 6) for c in range(23, 27)]
            + [('P', c, 10) for c in range(29, 33)]
        ),
        "coins": [
            (5, 10),
            (10, 8), (11, 8),
    ...
    # ── Level 7: Aurora Run ──────────────────────────────────────────────────
    {
        ...
        "bg_color": (95, 145, 205),
        "tiles": (
            [('G', c, 13) for c in range(0, 10)]
            + [('G', c, 14) for c in range(0, 10)]
